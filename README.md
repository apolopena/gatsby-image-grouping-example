...
- Using `yarn`
	- 
  ```bash
  git clone https://github.com/apolopena/gatsby-image-grouping-example.git && cd gatsby-image-grouping-example && yarn install && gatsby develop
...
1.  **Open the source code and start editing!**
    ...
    Open the `gatsby-image-grouping-example` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
